            ...
            <a-col :md="6" :sm="8">
              <a-form-item label="属性">
                <a-select v-model="queryParam.type" allowClear placeholder="请选择">
                  ...
                  <a-select-option :value="2">拼单商品</a-select-option>
                  <a-select-option :value="3">砍价商品</a-select-option>
                </a-select>
              </a-form-item>
            </a-col>
          </template>
  ...
  export default {
    ...
    methods: {
      ...
      async changeRecommended(e, row) {
       let info = '/ecommerce/mall/goods/info/' + row.id;
      ...
      async init(id) {
        ...
        this.$nextTick(async () => {
          ...
          let url = '/ecommerce/mall/specification/queryAll';
          ...
          let url1 = '/ecommerce/mall/goodssku/queryByGoodsId/' + this.goodsId;
