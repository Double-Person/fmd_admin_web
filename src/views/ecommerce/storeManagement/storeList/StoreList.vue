<template>
  <a-card :bordered="false">
    ...
    <!-- 表单区域 -->
    <StoreListModal ref="modalForm" @ok="modalFormOk"></StoreListModal>
  ...
  export default {
    ...
    data() {
      return {
        ...
        url: {
          list: '/ecommerce/mall/shops/list',
          delete: '/ecommerce/mall/shops/delete',
    ...
    computed: {
      ...
      // computedUse(val){
      //   return this.userList[0].roleName
      // }
    },
    beforeCreate(){
      thatFilter = this;
    ...
    methods: {
     ...
     async getUser(){
      ...
      // 删除还是恢复
      delOrResClick(id) {
        const url = '/ecommerce/mall/shops/delete'
        const params = [id];
