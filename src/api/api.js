...
/* 商城配置  StoreConfiguration */
/*
* http://101.132.114.244:81/platform-admin/mall/attribute/list
* http://101.132.114.244:81/platform-admin/mall/attribute/list?page=1&limit=10&name=
* /ecommerce/mall/attribute/list
* http://101.132.114.244:81/platform-admin/mall/brand/list?page=1&limit=10&name=
* */

export const attributeList = (params)=>getAction("/ecommerce/mall/attribute/list",params);
//  品牌制造商
export const brandList = (params)=> getAction("/ecommerce/mall/brand/list",params);
